...
const quoteArr = [
  ...
  {
    quote:
      "He who conquers himself is the mightiest warrior: Try not to become a man of success, but rather become a man of value",
    person: "Confucius",
  },
  {
    quote:
...
btn.addEventListener('click', function(){
    let quoteNumber = randomNum();
    quote.innerText = quoteArr[quoteNumber].quote;
    author.innerText = quoteArr[quoteNumber].person;
})